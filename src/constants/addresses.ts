...
export const ADDR_TESTNET: Record<string, Address> = {
  ...
  HATS_ALLOW_LIST: '0x0247615Ec9d73163a81CcF8218c9C48FD0dc6777',
  VOTE_CONTEST: '0x7Ce32b2C60Faf8A1b35eF5e3954cC499A462718D',
} as const;
...
export const ADDR_PROD: Record<string, Address> = {
  ...
  HATS_ALLOW_LIST: '0xd00CEdA81e6Ce6B47BFC6B19e8981C24aEa58368',
